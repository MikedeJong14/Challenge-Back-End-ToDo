...
<head>
	...
	<body>
		<div class="container">
			...
			<button class="btn btn-danger mb-2" onclick="hideAddListForm()" id="annuleerAddList">Annuleer</button>
							...
							<details <?= $open ?> >
								...
								<ul class="list-group">
									<li class="list-group-item p-1" >
										...
										<i class="fas fa-minus float-right m-2" title="Verwijder item"></i>
										...
										<div id="editListForm<?= $list['id'] ?>" class="editListForm">
										...
										<div id="addItemForm<?= $list['id'] ?>" class="addItemForm">
